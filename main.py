...
class SettingsScreen(Screen):
    def __init__(self, **kwargs):
        ...
        no_estes_triste=Label(text='Ya pero no estés triste puem mi princesita hermosa UwU',font_size=30)
